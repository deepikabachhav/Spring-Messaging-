...
public class AccountResource {
	...
	/*
	 * @PutMapping("/{accountNumber}") public ResponseEntity<Double>
	 * updateAccountBalance(@PathVariable Integer accountNumber,
	 * 
	 * @RequestParam Double currentBalance) { Optional<Account> optionalAccount =
	 * accountService.getAccountById(accountNumber); Account account =
	 * optionalAccount.get(); if (account == null) { return new
	 * ResponseEntity<>(null, HttpStatus.NOT_FOUND); }
	 * account.setCurrentBalance(currentBalance);
	 * accountService.addNewAccount(account); return new
	 * ResponseEntity<>(account.getCurrentBalance(), HttpStatus.OK); }
	 */
	public void updateAccountBalance(int accountNumber, double currentBalance) {
		Optional<Account> optionalAccount=accountService.getAccountById(accountNumber);
		Account account=optionalAccount.get();
		account.setCurrentBalance(currentBalance);
